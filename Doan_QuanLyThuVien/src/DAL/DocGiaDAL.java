...
public class DocGiaDAL {
	...
	public int changeProcessing(DocGiaDTO dg) {
		int result;
		String query = "update docgia set LopMon=\"" + dg.getLopMon()+"\", MaLoaiDocGia=\"" + dg.getLoaiDocGia().getMaLoaiDocGia()
				+"\", Email=\""
				+dg.getEmail()+"\",  std=\""+dg.getSdt()+"\", TenDocGia=\""+dg.getTenDocGia() +"\",  ngaySinh=\""+dg.getNgaySinh()
